...
namespace RE
{
	...
	public:
		...
		[[nodiscard]] constexpr reference       get(uint32_t a_num) noexcept { return a_num > size() - 1 ? operator[](size() - 1) : operator[](a_num); }
		[[nodiscard]] constexpr const_reference get(uint32_t a_num) const noexcept { return a_num > size() - 1 ? operator[](size() - 1) : operator[](a_num); }
